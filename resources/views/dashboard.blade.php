    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-8">
                <div class="card m-2">
                  <div class="card-body">
                    <h4 class="card-title fw-semibold">Hallo, {{Auth::user()->name}}</h4>
                    <p class="card-subtitle">What's your mood today?</p>
                      ...
                      <div class="hstack gap-9">
                        <a href="javascript:void(0)" class="text-center flex-shrink-0 ">
                          <div class="border border-2 border-primary rounded-circle">
                            <img src="{{asset('assets/images/music/s1.jpg')}}" class="rounded-circle img-fluid m-1" alt="art" width="55" />
                          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="overflow-auto mt-4" data-simplebar>
                    <div class="hstack gap-9">
                      ...
                      <a href="javascript:void(0)" class="text-center flex-shrink-0 ">
                        <div class="border border-2 border-primary rounded-circle">
                          <img src="{{asset('assets/images/music/s2.jpg')}}" class="rounded-circle img-fluid m-1" alt="art" width="55" />
                        </div>
                        <span class="d-block fs-3 mt-1  text-dark">John</span>
                      </a>
                      <a href="javascript:void(0)" class="text-center flex-shrink-0 ">
                        <div class="border border-2 border-primary rounded-circle">
                          <img src="{{asset('assets/images/music/s3.jpg')}}" class="rounded-circle img-fluid m-1" alt="art" width="55" />
                        </div>
                        <span class="d-block fs-3 mt-1  text-dark">Smith</span>
                      </a>
                      <a href="javascript:void(0)" class="text-center flex-shrink-0 ">
                        <div class="border border-2 border-white rounded-circle">
                          <img src="{{asset('assets/images/music/s4.jpg')}}" class="rounded-circle img-fluid m-1" alt="art" width="55" />
                        </div>
                      ...
                      <div class="card shadow-none border position-relative mb-md-0">
                        <div class="overflow-hidden rounded">
                          <a href="javascript:void(0)">
                            <img src="../assets/images/music/album5.jpg" class="rounded hover-img card-img" alt="art" />
                          </a>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                      <div class="card shadow-none border position-relative mb-md-0">
                        <div class="overflow-hidden rounded">
                          <a href="javascript:void(0)">
                            <div class="hover-img">
                              <img src="../assets/images/music/album7.jpg" class="rounded hover-img card-img" alt="art" />
                            </div>
                          </a>
                        </div>
                        <div class="p-2 d-flex">
                    ...
                    <div class="col-md-4 col-sm-6">
                      <div class="card border shadow-none position-relative mb-0">
                        <div class="overflow-hidden rounded">
                          <a href="javascript:void(0)">
                            <div class="hover-img">
                              <img src="../assets/images/music/album8.jpg" class="rounded hover-img card-img" alt="art" />
                            </div>
                          </a>
                        </div>
                        <div class="p-2 d-flex">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="hstack my-4 gap-3">
                    <a role="alert" class="alert mb-0 py-2 badge bg-primary-subtle text-primary s rounded-pill d-flex align-items-center justify-content-between gap-2 ">Shiela
                      On7 <span data-bs-dismiss="alert">
                        <i class="ti ti-square-x fs-4"></i>
                      </span>
                    </a>
                    <a role="alert" class="alert mb-0 py-2 badge bg-danger-subtle text-danger s rounded-pill d-flex align-items-center justify-content-between gap-2 ">Denny
                        ...
                        <div class="mplayer">
                          <div id="jp_container_N" class="jp-video-270p jp-state-no-volume">
                            <div class="jp-type-playlist">
                              ...
                              <div class="jp-gui">
                                <div class="jp-interface">
                                  <img src="{{asset('assets/images/music/album3.jpg')}}" class="rounded poster" alt="album" width="100" />
                            ...
                            <div class="jp-no-solution hide">
                              ...
                              to a recent version or update your <a href="http://get.adobe.com/flashplayer/" target="_blank">Flash plugin</a>.
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="m1">
                              <li>
                                <a class="dropdown-item" href="javascript:void(0)">
                                  <i class="ti ti-share text-muted me-1 fs-4"></i>Share
                                </a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="javascript:void(0)">
                                  <i class="ti ti-download text-muted me-1 fs-4"></i>Download
                                </a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="javascript:void(0)">
                                  <i class="ti ti-info-circle text-muted me-1 fs-4"></i>Get Song Info
                                </a>
                              </li>
                            </ul>
                          </div>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="mt-4 overflow-auto gap-4 h-450" data-simplebar>
                    <a href="javascript:void(0)" class="mb-4 d-block">
                      <img src="../assets/images/music/top10-1.jpg" class="img-fluid rounded" alt="album" />
                    </a>
                    <a href="javascript:void(0)" class="mb-4 d-block">
                      <img src="../assets/images/music/top10-2.jpg" class="img-fluid rounded" alt="album" />
                    </a>
                    <a href="javascript:void(0)" class="d-block">
                      <img src="../assets/images/music/top10-3.jpg" class="img-fluid rounded" alt="album" />
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="overflow-auto card mt-4 mb-0 shadow-none border h-450" data-simplebar>
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../assets/images/music/album1.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../assets/images/music/album2.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../assets/images/music/album3.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../assets/images/music/album4.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../assets/images/music/album5.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../assets/images/music/album6.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                        <h6 class="mb-0">N95</h6>
                        <span class="fs-3">Roddy Ricch</span>
                      </div>
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative">
                      ...
                      <img src="../assets/images/music/album7.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
              ...
              <div class="card">
                <div class="card-body p-4">
                  ...
                  <div class="mt-4 card p-3 rounded shadow-none border">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="../assets/images/music/album1.jpg" class="rounded" alt="album" width="97" />
                  ...
                  <div class="mt-4 card p-3 rounded shadow-none border">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="../assets/images/music/album2.jpg" class="rounded" alt="album" width="97" />
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                          <button class="btn btn-primary rounded-circle round p-0">
                            <i class="ti ti-player-play fs-5"></i>
                          </button>
                  ...
                  <div class="mt-4 card mb-0 p-3 rounded shadow-none border">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="../assets/images/music/album4.jpg" class="rounded" alt="album" width="97" />
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                          <button class="btn btn-primary rounded-circle round p-0">
                            <i class="ti ti-player-play fs-5"></i>
                          </button>
