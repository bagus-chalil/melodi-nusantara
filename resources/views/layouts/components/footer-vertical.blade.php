    ...
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-between py-7 flex-md-nowrap flex-wrap gap-sm-0 gap-3">
        <div class="d-flex gap-3 align-items-center">
          ...
          <p class="fs-4 mb-0">All rights reserved by IT KFHO. </p>
        </div>
        <div>
          <p class="mb-0">Produced by <a target="_blank" href="" class="text-primary link-primary">Survey IT X Umum Kimia Farma.</p></a>
        </div>
      </div>
    </div>
  </footer>
