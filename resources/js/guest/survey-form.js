$(document).ready(function () {
    $('#submitSurvey').on('click', function () {
        ...
        getCsrfToken().then(function () {
            $.ajax({
                url: '/survey/survey-guest/submit',
                method: 'POST',
                headers: {
                ...
                success: function (response) {
                    ...
                    Swal.fire({
                        ...
                        // Redirect ke halaman close setelah Swal selesai
                        window.location.href = '/survey/survey-guest/close';
                    });
                ...
                error: function (xhr) {
                    ...
                    if (xhr.status === 422) {
                        ...
                        for (let field in errors) {
                            ...
                            window.location.href = '#validationAlert';
                        }
